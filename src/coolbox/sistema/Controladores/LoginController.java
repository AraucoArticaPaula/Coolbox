...
public class LoginController implements Initializable {
    ...
    private void onLogin(ActionEvent event) {
        ...
        String sqlLogin = "SELECT u.id_usuario, u.nombre_usuario, e.id_empleado, e.id_tienda, e.nombres, e.apellidos, c.nombre_cargo "+ "FROM USUARIOS u "+ "INNER JOIN EMPLEADOS e ON u.id_empleado = e.id_empleado "+ "LEFT JOIN EMPLEADOS_CARGOS ec ON e.id_empleado = ec.id_empleado "+ "LEFT JOIN CARGOS c ON ec.id_cargo = c.id_cargo "+ "WHERE u.nombre_usuario = ? AND u.contrasena = ? AND u.estado = 'activo'";
