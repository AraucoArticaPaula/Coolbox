...
public class ModalPerfilController {
    ...
    private void cargarDatos() {
        String sql = "SELECT e.nombres, e.apellidos, e.DNI, e.celular, e.correo, "+ "u.nombre_usuario, u.id_usuario "+ "FROM EMPLEADOS e "+ "INNER JOIN USUARIOS u ON u.id_empleado = e.id_empleado "+ "WHERE e.id_empleado = ?";
