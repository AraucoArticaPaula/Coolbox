...
public class ModalTrasladosPendientesController {
    ...
    private void loadPendientes() {
        ...
        StringBuilder sql = new StringBuilder(
                "SELECT t.id_traslado, p.nombre AS producto, ti.nombre_tienda AS origen, t.id_tienda_destino, t.cantidad, t.estado "+ "FROM TRASLADOS t "+ "JOIN PRODUCTOS p ON t.id_producto = p.id_producto "+ "JOIN TIENDAS ti ON t.id_tienda_origen = ti.id_tienda "+ "WHERE t.estado = 'Pendiente'");
