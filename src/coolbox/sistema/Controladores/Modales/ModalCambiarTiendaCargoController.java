...
public class ModalCambiarTiendaCargoController {
    ...
    public void initData(Empleado empleado) {
        ...
        String sqlCargo = "SELECT C.nombre_cargo FROM CARGOS C "+ "JOIN EMPLEADOS_CARGOS EC ON C.id_cargo = EC.id_cargo "+ "WHERE EC.id_empleado = ?";
    ...
    private void guardarCambios() {
        ...
        try {
            ...
            String sql3 = "INSERT INTO EMPLEADOS_CARGOS (id_empleado, id_cargo) "+ "SELECT ?, id_cargo FROM CARGOS WHERE nombre_cargo = ?";
            ...
            if (idUsuario != -1) {
                ...
                String sqlInsRol = "INSERT INTO USUARIOS_ROLES (id_usuario, id_rol) "+ "SELECT ?, id_rol FROM ROLES WHERE nombre_rol = ?";
