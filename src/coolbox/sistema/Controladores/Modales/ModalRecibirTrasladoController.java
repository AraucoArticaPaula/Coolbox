...
public class ModalRecibirTrasladoController {
    ...
    private void loadResponsablesDestino() {
        ...
        String sql = "SELECT e.id_empleado, e.nombres, e.apellidos FROM EMPLEADOS e "+ "INNER JOIN EMPLEADOS_CARGOS ec ON e.id_empleado = ec.id_empleado "+ "INNER JOIN CARGOS c ON ec.id_cargo = c.id_cargo "+ "WHERE c.nombre_cargo IN ('Gerente', 'Subgerente') AND e.id_tienda = ?";
