...
public class ModalMovimientoInventarioController {
    ...
    @FXML
    private ComboBox<String> cmbTipoMovimiento;
    @FXML
    ...
    private void guardarMovimiento() {
        ...
        int idTienda = SesionUsuario.getIdTiendaUsuarioConectado();
        String nombreUsuarioSesion = SesionUsuario.getNombreUsuario();
        String usuarioActivo = (nombreUsuarioSesion != null && !nombreUsuarioSesion.isEmpty()) ? nombreUsuarioSesion : "Administrador";

        if (producto == null || tipo == null || cantidad <= 0 || idTienda <= 0) {
            return;
        }
        ...
        try (Connection connection = ConexionDB.getConnection()) {
            ...
            int idInventario = getInventarioId(connection, idTienda, producto.getIdProducto());
            ...
            if (idInventario > 0) {
                ...
                idInventario = createInventario(connection, idTienda, producto.getIdProducto(), cantidad);
            } else {
            ...
            saveMovimiento(connection, idInventario, idTienda, tipo.toLowerCase(), cantidad, motivo, usuarioActivo);
    ...
    private void saveMovimiento(Connection connection, int idInventario, int idTienda, String tipo, int cantidad, String motivo, String nombreUsuario) throws SQLException {
        String sql = "INSERT INTO MOVIMIENTOS_INVENTARIO(id_inventario, id_tienda, tipo_movimiento, cantidad, motivo, nombre_usuario, fecha) "+ "VALUES(?, ?, ?, ?, ?, ?, GETDATE())";
